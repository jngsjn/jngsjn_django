...
SECRET_KEY = 'django-insecure-ls$(h9@)+f#zwhuwht6*3^5photw565pc_0jueq^8%ow&+4vhy'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'blog', 'static')] #static 파일이 있는 경로 작성
